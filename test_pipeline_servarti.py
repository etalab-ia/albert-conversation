...
:root {
    ...
    --surface-elev-bg: #f9fafb;

    /* Accents */
    --accent: #3b82f6; /* blue-500 */
    --highlight-bg: #dbeafe; /* blue-100 */
    --highlight-text: #1e40af; /* blue-800 */
...
@media (prefers-color-scheme: dark) {
    :root {
        /* Body background (gradient) */
        --body-bg-start: #0f172a; /* slate-900 */
        --body-bg-mid: #0b1220;  /* deep slate */
        --body-bg-end: #111827;  /* slate-800 */

        /* Text colors */
        --text-primary: #e5e7eb; /* slate-200 */
        --text-secondary: #cbd5e1; /* slate-300 */
        --text-muted: #94a3b8; /* slate-400 */
        --title-color: #e5e7eb;   /* slate-200 */
        ...
        --surface-elev-bg: #0f172a; /* slate-900 */

        /* Accents keep same blue */
        --highlight-bg: #1e3a8a33; /* translucent blue-900 */
        --highlight-text: #93c5fd; /* blue-300 */
...
/* Explicit overrides from OpenWebUI theme attribute on <html> */
...
html[theme='dark'], html[data-theme='dark'] {
    ...
    --surface-elev-bg: #0f172a;
    --highlight-bg: #1e3a8a33;
...
.source-content {
    ...
    background: var(--surface-elev-bg);
    padding: 16px;
    border-radius: 6px;
...
def sync_research(
    ...
    try:
        ...
        yield {
            ...
            "data": {
                "type": "iframe",
                # Return only semantic markup; styling is applied in the frontend based on theme
                "content": f"""
