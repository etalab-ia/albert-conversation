...
from open_webui.custom_functions.pipes.assistant_juridique_web.assistant_juridique_web_settings import (
...
class Pipe:
    class Valves(BaseModel):
        ...
        DEFAULT_MODEL: str = Field(default="albert-large")
        pass
    ...
    async def pipe(
        ...
        # from open_webui.custom_functions.pipes.assistant_juridique_web.tools import (
        #    run_research,
        # )

        from open_webui.custom_functions.tools.deepsearch_tool_v2 import (
            run_research,
        )
        ...
        if complex_or_not.strip().lower() == "complex":
            ...
            messages = [
                {
                    "role": "user",
                    "content": f"Tu es un assistant qui répond à des questions en te basant sur un contexte. Tu parles en français. Tu es précis et poli.",
                },
                {
                    "role": "user",
