PROMPT_SEARCH = """
Tu es un assistant qui cherche des documents pour répondre à une question. Tu te bases sur le contexte de la conversation pour comprendre la recherche a effectuer.
{prompt_search_addon}
